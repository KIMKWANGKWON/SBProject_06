  ...
  <ul class="navbar-nav">
   ...
   <ul class="navbar-nav">
    ...
    <div class="dropdown-menu">
      <h5 class="dropdown-header"><a href="/user/mypage/1">마이페이지</a></h5>
      <a class="dropdown-item" href="/user/favorites/1">즐겨찾기</a>
      <a class="dropdown-item" href="/user/reservationList/1">예약 현황</a>
      <a class="dropdown-item" href="#">Link 3</a>
      <h5 class="dropdown-header">식당 관리</h5> <!-- 사업자라면 -->
      <a class="dropdown-item" href="/owner/restaurantList/1">내 식당 보기</a>
    </div>
  </div>
    </li>
  </ul>
